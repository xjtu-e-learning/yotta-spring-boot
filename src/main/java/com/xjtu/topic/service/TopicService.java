...
public class TopicService {
    ...
    public Result getCompleteTopicByTopicName(String topicName, String hasFragment)
    {
        ...
        List<TopicContainFacet> topicContainFacets = new ArrayList<>();
        logger.debug(String.valueOf(topicList.size()));
        for(Topic topic : topicList)
        {
            ...
            topicContainFacets.add(topicContainFacet);
        }
        return ResultUtil.success(ResultEnum.SUCCESS.getCode(), ResultEnum.SUCCESS.getMsg(), topicContainFacets);
    }
