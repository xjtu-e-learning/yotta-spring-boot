...
//    public static String DOMAIN_LAYER_RELATION_TABLE = "domain_layer_relation";
    ...
    public final static String FACET_RELATION_TABLE = "facet";
    ...
    public static String userAgent = "Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/75.0.3770.100 Safari/537.36";
...
public static int timeOutSO = new Random().nextInt(10000) + 20000;
    ...
    public static String IE_PATH = "E:\\IEDriverServer.exe";  // IE模拟
    public static String CHROME_PATH = "D:\\Yotta\\chromedriver.exe";  // Chrome模拟

    /**20190628新增
     * Mysql 配置
     */
    public static String DBNAME = "yotta_spring_boot_test";
